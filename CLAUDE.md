...
URL-based locale strategy: `/` = Spanish (base), `/en/` = English. Configured via Paraglide JS v2.

- **Messages**: `messages/es.json` and `messages/en.json` — all user-facing strings
...
- Content is bilingual (Spanish default + English) via Paraglide i18n
