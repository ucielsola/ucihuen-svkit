...
import { remove, filter, children, find, closest, parents, parent, prevAll, prev, nextAll, next, prepend, append, eq, index, is, text, html, each, css, offset, styles, outerHeight, outerWidth, transitionEnd as transitionEnd$1, trigger, off, on, transition as transition$1, transform, removeAttr, attr, toggleClass, hasClass, removeClass, addClass, $ } from "dom7";
const Methods = {
  addClass,
  removeClass,
  hasClass,
