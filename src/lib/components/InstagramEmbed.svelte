...
<div class="instagram-embed-container" bind:this={embedContainer}>
	...
	<div class="embed-wrapper" class:visible={!loading}>
		<blockquote
			...
			data-instgrm-permalink="https://www.instagram.com/ucihuen/?utm_source=ig_embed&utm_campaign=loading"
			data-instgrm-version="14"
			style="background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; min-width:326px; padding:0; width:calc(100% - 2px);"
		>
			<div style="padding:16px;">
				<a
					href="https://www.instagram.com/ucihuen/?utm_source=ig_embed&utm_campaign=loading"
